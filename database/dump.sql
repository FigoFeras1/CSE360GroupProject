...
-- 3 +/- SELECT COUNT(*) FROM ORDERS.PENDING;  
INSERT INTO "ORDERS"."PENDING" VALUES
(1, JSON '"{\"size\":\"LARGE\",\"base\":\"CHEESE\",\"toppings\":[\"MUSHROOMS\",\"ONIONS\"]}"', DATE '2022-11-07', 10),
(2, JSON '"{\"size\":\"LARGE\",\"base\":\"CHEESE\",\"toppings\":[\"MUSHROOMS\",\"ONIONS\"]}"', DATE '2022-11-07', 10),
(3, JSON '"{\"size\":\"LARGE\",\"base\":\"CHEESE\",\"toppings\":[\"MUSHROOMS\",\"ONIONS\"]}{\"size\":\"SMALL\",\"base\":\"VEGAN\",\"toppings\":[\"OLIVES\",\"PINEAPPLE\"]}"', DATE '2022-11-07', 10);      
